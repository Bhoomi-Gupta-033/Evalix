              ...
              >
                {session.status === "active" && (
                  <div className="absolute top-3 right-3">
                    <div className="badge  text-black bg-blend-color badge-success gap-1">
                ...
                <div className="card-body p-5">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span
                        className={`badge  text-black bg-blend-color badge-sm ${getDifficultyBadgeClass(session.difficulty)}`}
                      >
                        {session.difficulty}
                      </span>
                    </div>
